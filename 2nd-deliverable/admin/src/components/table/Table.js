...
const List = () => {
    ...
    return (
        ...
        <Table sx={{ minWidth: 650 }} aria-label="simple table">
          <TableHead>
            <TableRow>
              <TableCell className="table-cell">hotel ID</TableCell>
              ...
              <TableCell className="table-cell">Paymeent Method</TableCell>
              ...
              >
                ...
                <TableCell className="table-cell">
                    <div className="cell-wrapper"> 
                        <img className="image" src={row.img} alt="hotel"/>
                    </div>
                    </TableCell>
...
//TODO: need to finish this up. Table is disproportionate on Home page